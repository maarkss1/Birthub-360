...
const USERS: SeedUserDefinition[] = [
    ...
    { name: 'Marcelo do Nascimento', email: 'marcelo.donascimento@atlasgr.com.br', role: 'GESTOR', passwordEnvVar: 'SEED_PASSWORD_MARCELO_GESTOR', joinOrganizationOfEmail: 'marcelo.nascimento@atlasgr.com.br' },
];
