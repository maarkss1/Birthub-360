...
-- a identidade/produtos de uma única organização (Atlas GR), não por-tenant. Qualquer outra
-- organização que configurasse uma VoiceHubConnection própria recebia a IA se apresentando como
-- "Gessica da Atlas GR" e oferecendo produtos de gestão de risco de frota para os próprios leads
...
-- correção (o hardcoded da Atlas GR) — zero mudança de comportamento no deploy para quem já está
...
SET
  ...
  "scriptCompanyDescription" = 'A Atlas GR nasceu em 2004 e tem mais de 20 anos de experiência protegendo operações de transporte e logística. Hoje atendemos mais de 390 clientes e monitoramos mais de 125 mil viagens por mês. Temos tecnologia própria e somos homologados por todas as principais seguradoras do mercado.
...
2. **CIA (Célula de Inteligência Atlas)**: Pronta resposta, acionamento policial e recuperação de carga.',
  ...
  "scriptClosingLine" = 'Muito obrigada pela atenção e pelo carinho! Um abraço de toda a equipe Atlas GR e um excelente dia pra você! Tchau, tchau!'
