...
"corrija" isso pra reagir à marca ativa, é o comportamento certo (ver `AGENTS.md` seção 7, item 7).
...
da escolha de marca? Exemplo real do Piloto 001 (`.Codex/PILOTS.md`): `TotalTrackLogo` já tem
...
Achado real do Piloto 002 (`DecisionMakerSearch.tsx`/`CandidateCard.tsx`, ver `.Codex/PILOTS.md`):
