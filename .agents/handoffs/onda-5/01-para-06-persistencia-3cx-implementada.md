...
- Status: resolvido (revisado por 06 e por 12 na Onda 7 — ver as duas seções "## Resolução"
  abaixo; item 2 redirecionado ao Agente 12, novo dono de `threecx/**` a partir da Onda 7)
- Prioridade: normal
