...
comentário no próprio `prisma/schema.prisma`: _"política fixa de governança do produto, sem
necessidade real de customização por organização em runtime"_ — mesmo padrão de
