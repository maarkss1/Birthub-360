# BIRTH HUB 360 — ONDA Z — GO-TO-MARKET READINESS & CERTIFICATION

| | |
|---|---|
| **Prioridade** | P1 |
| **Trilha** | T7 — CERTIFICAÇÃO |
| **Posição na ordem recomendada** | 34 de 34 |
| **Depende de** | A, B, D, J, P, Q, S, W, AB, AC |
| **Habilita** | — |
...
Certificar o Birth Hub 360 como produto comercializável, operável e demonstrável — com prova, não com slide.

**Por que agora:** É a onda que audita todas as anteriores. Só faz sentido rodar quando houver o que certificar.
...
Crie `docs/waves/post-09/ONDA_Z_DISCOVERY.md` contendo mapa técnico, estado atual, evidência por arquivo:linha, lacunas reais, riscos, decisões e plano de execução.
...
Crie `docs/waves/post-09/ONDA_Z_REPORT.md` seguindo `templates/TEMPLATE_REPORT.md`.
...
## CRITÉRIOS DE ACEITE ESPECÍFICOS DA ONDA Z

Cada critério é uma afirmação falsificável. Para cada um, anexe a evidência correspondente.

1. Matriz de certificação preenchida por onda com status, evidência e link — onda sem evidência é marcada como não certificada, nunca como concluída.
2. Demonstração completa executada em ambiente limpo a partir de script versionado, com tempo registrado e sem intervenção não prevista.
3. Pacote de due diligence existe e está completo: arquitetura, segurança, privacidade, sub-processadores, SLA, plano de continuidade.
4. Registro de riscos aceitos assinado pelo responsável, com data de revisão, para cada item não resolvido.
5. Critérios de 'não lançar' estão escritos e foram verificados um a um.
6. Nenhuma referência a AtlasGR ou Total Trac em código, documentação, artefatos de marca ou telas — varredura anexada.
...
```
ONDA Z — GO-TO-MARKET READINESS & CERTIFICATION
