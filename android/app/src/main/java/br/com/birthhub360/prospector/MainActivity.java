package br.com.birthhub360.prospector;
...
/**
 * Ponto de entrada nativo do app Birth Hub 360 Prospector (Capacitor).
 *
 ...
 * - esquema custom `birthhub360://<destino>` (sem autoVerify, sempre funciona sem depender de DNS);
...
public class MainActivity extends BridgeActivity {
    ...
    private static final String TAG = "BirthHub360DeepLink";
    ...
    /**
     * Esquema custom `birthhub360://<destino>` → host da URI é o destino (ex.: "birthhub360://crm" tem
     * host="crm"; "birthhub360://" sem host retorna string vazia, tratado como dashboard).
