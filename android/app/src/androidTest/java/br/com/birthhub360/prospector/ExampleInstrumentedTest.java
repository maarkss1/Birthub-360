 ...
 * "br.com.birthhub360.prospector", ver android/app/build.gradle). Rodar `connectedAndroidTest` falharia
...
public class ExampleInstrumentedTest {
    ...
    public void useAppContext() throws Exception {
        ...
        assertEquals("br.com.birthhub360.prospector", appContext.getPackageName());
    }
}
