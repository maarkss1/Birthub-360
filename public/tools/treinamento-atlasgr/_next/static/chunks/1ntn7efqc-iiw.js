(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function w({ children: e, cacheNode: t }) {
      ...
      return (0, s.jsx)(O, { focusAndScrollRef: r.focusAndScrollRef, cacheNode: t, children: e });
    }
    function S({
      tree: e,
      segmentPath: t,
    ...
    function A({
      ...
      do {
        ...
        let _ = (function (e) {
          ...
          O = (0, s.jsxs)(u.TemplateContext.Provider, { value: R, children: [a, o, i] }, d);
        (H.push(O), (X = X.next));
      } while (null !== X);
      return H;
    }
  ...
  (e, t, r) => {
    ...
    function E(e, t, r) {
      return new Proxy(e, {
        get: (e, n, a) => (
          'string' != typeof n || p.wellKnownProperties.has(n) || t.has(n) || g(O(r, n)),
          Reflect.get(e, n, a)
        ),
        has: (e, n) => (
          'string' != typeof n || p.wellKnownProperties.has(n) || t.has(n) || g(O(r, n)),
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case 'validation-client':
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(918450);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(918450),
  ...
  (e, t, r) => {
          ...
          case 'request':
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(918450),
    ...
    function R(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(918450);
      return Promise.resolve(
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ('u' < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(269882);
        r = o(c);
        let { createParamsFromClient: i } = e.r(541489);
        return ((a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r }));
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(266996),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(797689),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ('u' < typeof window) {
        let { createParamsFromClient: a } = e.r(541489),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(797689),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
