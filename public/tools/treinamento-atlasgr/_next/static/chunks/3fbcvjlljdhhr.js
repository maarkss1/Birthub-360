  ...
  (e) => {
    ...
    function g() {
      ...
      return (0, a.jsx)('button', {
        ...
        children: i ? (0, a.jsx)(f, { size: 16 }) : (0, a.jsx)(p, { size: 16 }),
      });
    }
    var v = e.i(861873),
      b = e.i(522547);
    let h = (0, s.default)('bell', [
      ...
      [
        ...
        function ({ hideNavLinks: e = !1 }) {
          ...
          let c,
            ...
            S = (0, t.useRef)(null),
            q = (0, r.usePathname)(),
            k = (0, v.useOnboardingStore)((e) => e.registration),
            w = (0, v.useOnboardingStore)((e) => e.xp);
          ((0, t.useEffect)(() => {
            queueMicrotask(() => p(!0));
            let e = () => {
              let e = window.scrollY;
              (A(e > 20), e > R.current && e > 80 ? (y(!0), h(!1)) : y(!1), (R.current = e));
            };
            return (
            ...
            (0, t.useEffect)(() => {
              if (!f) return;
              let e = (e) => {
                'Escape' === e.key && (queueMicrotask(() => h(!1)), S.current?.focus());
              };
              return (
          ...
          let { current: P } = (0, b.levelProgress)(w),
            T = e || '/' === q;
                ...
                children: [
                  ...
                  !T &&
                    (0, a.jsx)('nav', {
                      ...
                      children: j.map((e) => {
                        let r = q === e.href || q?.startsWith(`${e.href}/`);
                        return (0, a.jsxs)(
                          o.default,
                          {
                            href: e.href,
                  ...
                  (0, a.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, a.jsx)('button', {
                        ...
                        onClick: () => h((e) => !e),
                        'aria-label': f ? 'Fechar menu' : 'Abrir menu',
                        'aria-expanded': f,
                        'aria-controls': 'mobile-nav',
                        children: f ? (0, a.jsx)(n.X, { size: 18 }) : (0, a.jsx)(i, { size: 18 }),
                      }),
                    ],
                  }),
                ],
      ...
      function () {
        let [e, n] = (0, o.useState)(''),
          d = (0, o.useMemo)(() => {
            ...
            return a
              ? i.glossary.filter(
                  (e) => e.term.toLowerCase().includes(a) || e.definition.toLowerCase().includes(a),
                )
              : i.glossary;
          }, [e]);
        return (0, a.jsxs)('div', {
          ...
          children: [
            (0, a.jsx)(t.SiteHeader, {}),
            (0, a.jsxs)('main', {
              className: 'mx-auto max-w-4xl px-4 py-10 sm:px-6',
              children: [
                (0, a.jsx)('h1', {
                  className: 'font-display text-3xl font-bold text-foreground',
                  children: 'Glossário Técnico',
                }),
                (0, a.jsxs)('p', {
                  className: 'mt-2 text-muted',
                  children: [
                    i.glossary.length,
                    ' termos reunidos a partir dos materiais internos da ATLASGR e de fontes públicas do setor de transporte e seguros. Novos termos serão incorporados conforme os demais módulos forem concluídos.',
                  ],
                }),
                (0, a.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, a.jsx)('input', {
                      ...
                      className:
                        'h-12 w-full rounded-full border border-border bg-surface pl-11 pr-4 text-sm outline-none focus:border-atlas-orange',
                    }),
                  ],
                }),
                (0, a.jsxs)('div', {
                  ...
                  children: [
                      ...
                      (0, a.jsxs)(
                        s.Card,
                        {
                          ...
                          children: [
                            ...
                            e.atlasUsage &&
                              (0, a.jsxs)('p', {
                                className: 'mt-2 text-xs text-atlas-orange/90',
                                children: ['Como a Atlas usa: ', e.atlasUsage],
                              }),
                          ],
                        },
                        e.id,
                    ...
                    0 === d.length &&
                      (0, a.jsxs)('p', {
                        ...
                        children: ['Nenhum termo encontrado para “', e, '”.'],
                      }),
                  ],
                }),
              ],
