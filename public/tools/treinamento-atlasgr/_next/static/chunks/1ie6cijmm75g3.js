(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    var O = (S.prototype = new j());
    ((O.constructor = S), v(O, x.prototype), (O.isPureReactComponent = !0));
    var E = Array.isArray;
    function w() {}
        ...
        !(function e(t, r, n, i, a) {
          ...
          if (E(t))
            ...
            for (t = b.call(t), b = 0; !(i = t.next()).done;)
              ((f = p + C((i = i.value), b++)), (d += e(i, r, n, f, a)));
          else if ('object' === f) {
    ...
    function U(e) {
      ...
      try {
        var n = e(),
          o = T.S;
        (null !== o && o(r, n),
          'object' == typeof n && null !== n && 'function' == typeof n.then && n.then(w, N));
      } catch (e) {
        N(e);
      } finally {
  ...
  (e, t, r) => {
    ...
    function b({ errorComponent: e, errorStyles: t, errorScripts: r, children: n }) {
  ...
  (e, t, r) => {
    ...
    let u = e.r(954839),
      ...
      l = i[u.VIEWPORT_BOUNDARY_NAME.slice(0)],
      s = i[u.OUTLET_BOUNDARY_NAME.slice(0)],
      c = i[u.ROOT_LAYOUT_BOUNDARY_NAME.slice(0)];
  },
  742732,
  (e, t, r) => {
    'use strict';
    ...
    function i(e, t) {
      for (let [r, i] of Object.entries(t)) {
        ...
        ('SCRIPT' === e.tagName && u(a) ? (e[a] = !!i) : e.setAttribute(a, String(i)),
          (!1 === i || ('SCRIPT' === e.tagName && u(a) && (!i || 'false' === i))) &&
