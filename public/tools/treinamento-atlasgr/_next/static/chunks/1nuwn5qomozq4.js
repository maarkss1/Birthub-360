      ...
      (e.exports = (function () {
        var t = [
            ...
            function (t, e, i) {
              ...
              for (var a in ((s.prototype = Object.create(r.prototype)), r)) s[a] = r[a];
            ...
            function (t, e, i) {
              ...
              for (var g in ((l.prototype = Object.create(r.prototype)), r)) l[g] = r[g];
              ((l.prototype.getEdges = function () {
                ...
                (l.prototype.scatter = function () {
                  var t,
                    e,
                    i = -s.INITIAL_WORLD_BOUNDARY,
                    r = s.INITIAL_WORLD_BOUNDARY;
                  t = s.WORLD_CENTER_X + a.nextDouble() * (r - i) + i;
                  var n = -s.INITIAL_WORLD_BOUNDARY,
                    o = s.INITIAL_WORLD_BOUNDARY;
                  ((e = s.WORLD_CENTER_Y + a.nextDouble() * (o - n) + n),
                    (this.rect.x = t),
                    (this.rect.y = e));
                }),
                      ...
                      (this.labelWidth > e &&
                        ...
                        this.labelHeight > i &&
                          ('center' == this.labelPos
                            ...
                            : 'top' == this.labelPos && (this.rect.y -= this.labelHeight - i),
                ...
                (l.prototype.transform = function (t) {
                  ...
                  i > s.WORLD_BOUNDARY
                    ? (i = s.WORLD_BOUNDARY)
                    : i < -s.WORLD_BOUNDARY && (i = -s.WORLD_BOUNDARY);
                  var r = new h(e, i),
            ...
            function (t, e, i) {
              ...
              for (var d in ((c.prototype = Object.create(r.prototype)), r)) c[d] = r[d];
              ((c.prototype.getNodes = function () {
                ...
                (c.prototype.updateLeftTop = function () {
                  ...
                  return r == n.MAX_VALUE
                    ? null
                    : ((i =
                        void 0 != s[0].getParent().paddingLeft
                  ...
                  (a == n.MAX_VALUE &&
                    ...
                    (s =
                      void 0 != c[0].getParent().paddingLeft
                        ...
                        : this.margin),
                    (this.left = y.x - s),
                    (this.right = y.x + y.width + s),
                    (this.top = y.y - s),
                    (this.bottom = y.y + y.height + s));
                }),
                ...
                (c.prototype.updateConnected = function () {
                  ...
                  for (
                    ...
                    for (var s = (t = (o = r.shift()).getEdges()).length, a = 0; a < s; a++)
                      null == (e = t[a].getOtherEndInGraph(o, this)) ||
                        n.has(e) ||
            ...
            function (t, e, i) {
              ...
              var r,
                n = i(1);
              function o(t) {
                ((r = i(5)), (this.layout = t), (this.graphs = []), (this.edges = []));
              }
              ((o.prototype.addRoot = function () {
                ...
                (o.prototype.remove = function (t) {
                  if (t instanceof r) {
                    ...
                    for (
                      var e, i, o = [], s = (o = o.concat(t.getEdges())).length, a = 0;
                      a < s;
                      a++
                    )
                      ((e = o[a]), t.remove(e));
                ...
                (o.prototype.includesInvalidEdge = function () {
                  for (var t, e = this.edges.length, i = 0; i < e; i++)
                    if (((t = this.edges[i]), this.isOneAncestorOfOther(t.source, t.target)))
                      return !0;
                  return !1;
                }),
                (t.exports = o));
            ...
            function (t, e, i) {
              ...
              ((n.calcSeparationAmount = function (t, e, i, r) {
                ...
                (n.getIntersection2 = function (t, e, i) {
                  ...
                  if (r === o)
                    n > s
                      ? ((i[0] = r), (i[1] = h), (i[2] = o), (i[3] = A))
                      : n < s && ((i[0] = r), (i[1] = u), (i[2] = o), (i[3] = y));
                  else if (n === s)
                    r > o
                      ? ((i[0] = a), (i[1] = n), (i[2] = E), (i[3] = s))
                      : r < o && ((i[0] = l), (i[1] = n), (i[2] = f), (i[3] = s));
                  else {
                    ...
                    if (
                      (-O === D
                        ? (r > o ? ((i[0] = g), (i[1] = u)) : ((i[0] = l), (i[1] = h)), (L = !0))
                        : O === D &&
                          (r > o ? ((i[0] = a), (i[1] = h)) : ((i[0] = c), (i[1] = u)), (L = !0)),
                      -I === D
                        ? (o > r ? ((i[2] = v), (i[3] = A)) : ((i[2] = E), (i[3] = y)), (m = !0))
                        : I === D &&
                          (o > r ? ((i[2] = f), (i[3] = y)) : ((i[2] = T), (i[3] = A)), (m = !0)),
                      L && m)
                    )
                      return !1;
                    if (
                      (r > o
                        ? n > s
                          ? ((w = this.getCardinalDirection(O, D, 4)),
                            (R = this.getCardinalDirection(I, D, 2)))
                          : ((w = this.getCardinalDirection(-O, D, 3)),
                            (R = this.getCardinalDirection(-I, D, 1)))
                        : n > s
                          ? ((w = this.getCardinalDirection(-O, D, 1)),
                            (R = this.getCardinalDirection(-I, D, 3)))
                          : ((w = this.getCardinalDirection(O, D, 2)),
                            (R = this.getCardinalDirection(I, D, 4))),
                      !L)
                    )
                      switch (w) {
                        case 1:
                          ((M = h), (C = r + -p / D), (i[0] = C), (i[1] = M));
                          break;
                        case 2:
                          ((C = c), (M = n + d * D), (i[0] = C), (i[1] = M));
                          break;
                        case 3:
                          ((M = u), (C = r + p / D), (i[0] = C), (i[1] = M));
                          break;
                        case 4:
                          ((C = g), (M = n + -d * D), (i[0] = C), (i[1] = M));
                      }
                    if (!m)
                      switch (R) {
                        case 1:
                          ((x = y), (G = o + -_ / D), (i[2] = G), (i[3] = x));
                          break;
                        case 2:
                          ((G = T), (x = s + N * D), (i[2] = G), (i[3] = x));
                          break;
                        case 3:
                          ((x = A), (G = o + _ / D), (i[2] = G), (i[3] = x));
                          break;
                        case 4:
                          ((G = v), (x = s + -N * D), (i[2] = G), (i[3] = x));
                      }
                  }
                  return !1;
                }),
            ...
            function (t, e, i) {
              ...
              ((c.RANDOM_SEED = 1),
                ...
                (c.prototype.createDummyNodesForBendpoints = function (t) {
                  ...
                  var s = this.newEdge(null);
                  return (
                    this.graphManager.add(s, i, t.target),
                  ...
                  for (var e = 0; e < t.length; e++) {
                    ...
                    if (i.bendpoints.length > 0) {
                      for (var n = this.edgeToDummyNodes.get(i), o = 0; o < n.length; o++) {
                        var s = n[o],
                          a = new l(s.getCenterX(), s.getCenterY()),
                  ...
                  for (l = l.concat(i); !n;) {
                    ...
                    for (var s = 0; s < e.length; s++) {
                      var a = e[s],
                        u = e.indexOf(a);
                      (u >= 0 && e.splice(u, 1),
                        a.getNeighborsList().forEach(function (t) {
                          if (0 > i.indexOf(t)) {
                            var e = r.get(t) - 1;
            ...
            function (t, e, i) {
              ...
              ((h.prototype.initParameters = function () {
                ...
                (h.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t, e, i, r, s, a, h = this.getGraphManager().getAllEdges(), l = 0;
                    l < h.length;
                    l++
                  )
                    (((t = h[l]).idealLength = this.idealEdgeLength),
                      t.isInterGraph &&
                        ((i = t.getSource()),
                        (r = t.getTarget()),
                        (s = t.getSourceInLca().getEstimatedSize()),
                        (a = t.getTargetInLca().getEstimatedSize()),
                        this.useSmartIdealEdgeLengthCalculation &&
                          (t.idealLength += s + a - 2 * o.SIMPLE_NODE_SIZE),
                        (e = t.getLca().getInclusionTreeDepth()),
                        (t.idealLength +=
                          n.DEFAULT_EDGE_LENGTH *
                          n.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (i.getInclusionTreeDepth() + r.getInclusionTreeDepth() - 2 * e))));
                }),
                ...
                (h.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      ...
                      ((i = h[t]), this.calculateRepulsionForceOfANode(i, o, s, a), o.add(i));
                  else
                ...
                (h.prototype.calcSpringForce = function (t, e) {
                  var i,
                    ...
                    s = t.getSource(),
                    a = t.getTarget();
                  if (this.uniformLeafNodeSizes && null == s.getChild() && null == a.getChild())
                    t.updateLengthSimple();
                  else if ((t.updateLength(), t.isOverlapingSourceAndTarget)) return;
                  0 != (i = t.getLength()) &&
                    ((n = (r = this.springConstant * (i - e)) * (t.lengthX / i)),
                    (o = r * (t.lengthY / i)),
                    (s.springForceX += n),
                    (s.springForceY += o),
                    (a.springForceX -= n),
                ...
                (h.prototype.calcRepulsionForce = function (t, e) {
                  var i,
                    ...
                    f = [, , , ,];
                  if (c.intersects(d)) {
                    (s.calcSeparationAmount(c, d, p, n.DEFAULT_EDGE_LENGTH / 2),
                      (g = 2 * p[0]),
                      (u = 2 * p[1]));
                    var y = (t.noOfChildren * e.noOfChildren) / (t.noOfChildren + e.noOfChildren);
                    ((t.repulsionForceX -= y * g),
                      (t.repulsionForceY -= y * u),
                      (e.repulsionForceX += y * g),
                      (e.repulsionForceY += y * u));
                  } else
                    (this.uniformLeafNodeSizes && null == t.getChild() && null == e.getChild()
                      ? ((i = d.getCenterX() - c.getCenterX()),
                        (r = d.getCenterY() - c.getCenterY()))
                      : (s.getIntersection(c, d, f), (i = f[2] - f[0]), (r = f[3] - f[1])),
                      Math.abs(i) < n.MIN_REPULSION_DIST && (i = a.sign(i) * n.MIN_REPULSION_DIST),
                      Math.abs(r) < n.MIN_REPULSION_DIST && (r = a.sign(r) * n.MIN_REPULSION_DIST),
                      (h = Math.sqrt((o = i * i + r * r))),
                      (g =
                        ((l = (this.repulsionConstant * t.noOfChildren * e.noOfChildren) / o) * i) /
                        h),
                      (u = (l * r) / h),
                      (t.repulsionForceX -= g),
                      (t.repulsionForceY -= u),
                ...
                (h.prototype.addNodeToGrid = function (t, e, i) {
                  ...
                  for (var a = r; a <= n; a++)
                    for (var h = o; h <= s; h++)
                      (this.grid[a][h].push(t), t.setGridCoordinates(r, n, o, s));
                }),
                ...
                (h.prototype.calculateRepulsionForceOfANode = function (t, e, i, r) {
                  if ((this.totalIterations % n.GRID_CALCULATION_CHECK_PERIOD == 1 && i) || r) {
                    var o,
                      s = new Set();
                    t.surrounding = [];
                    for (var a = this.grid, h = t.startX - 1; h < t.finishX + 2; h++)
                      for (var l = t.startY - 1; l < t.finishY + 2; l++)
                        if (!(h < 0 || l < 0 || h >= a.length || l >= a[0].length)) {
                          for (var g = 0; g < a[h][l].length; g++)
                            if (
                              ((o = a[h][l][g]),
                              t.getOwner() == o.getOwner() && t != o && !e.has(o) && !s.has(o))
                            ) {
                              var u =
                              ...
                              u <= this.repulsionRange && c <= this.repulsionRange && s.add(o);
                            }
                        }
            ...
            function (t, e, i) {
              ...
              var r = i(1),
                n = i(7);
              function o(t, e, i) {
                (r.call(this, t, e, i), (this.idealLength = n.DEFAULT_EDGE_LENGTH));
              }
            ...
            function (t, e, i) {
              ...
              ((n.prototype.setGridCoordinates = function (t, e, i, r) {
        ...
        var e = [
            ...
            function (t, e, i) {
              ...
              ((n.DEFAULT_USE_MULTI_LEVEL_SCALING = !1),
                ...
                (n.TREE_REDUCTION_ON_INCREMENTAL = !1),
                (t.exports = n));
            },
            function (t, e, i) {
              'use strict';
              var r = i(0).FDLayoutEdge;
              function n(t, e, i) {
                r.call(this, t, e, i);
              }
              for (var o in ((n.prototype = Object.create(r.prototype)), r)) n[o] = r[o];
              ...
              ((o.prototype.move = function () {
                ...
                (o.prototype.propogateDisplacementToChildren = function (t, e) {
                  for (var i, r = this.getChild().getNodes(), n = 0; n < r.length; n++)
                    null == (i = r[n]).getChild()
                      ? (i.moveBy(t, e), (i.displacementX += t), (i.displacementY += e))
            ...
            function (t, e, i) {
              ...
              var r = i(0).FDLayout,
                ...
                a = i(2),
                h = i(1),
                l = i(0).FDLayoutConstants,
                g = i(0).LayoutConstants,
                u = i(0).Point,
                c = i(0).PointD,
                d = i(0).Layout,
                p = i(0).Integer,
              ...
              for (var A in ((v.prototype = Object.create(r.prototype)), r)) v[A] = r[A];
              ((v.prototype.newGraphManager = function () {
                var t = new n(this);
                return ((this.graphManager = t), t);
              }),
                (v.prototype.newGraph = function (t) {
                  return new o(null, this.graphManager, t);
                }),
                (v.prototype.newNode = function (t) {
                  return new s(this.graphManager, t);
                }),
                (v.prototype.newEdge = function (t) {
                  return new a(null, null, t);
                }),
                (v.prototype.initParameters = function () {
                  (r.prototype.initParameters.call(this, arguments),
                    this.isSubLayout ||
                      ...
                      (this.springConstant = l.DEFAULT_SPRING_STRENGTH),
                      (this.repulsionConstant = l.DEFAULT_REPULSION_STRENGTH),
                      ...
                      (this.finalTemperature = l.CONVERGENCE_CHECK_PERIOD / this.maxIterations),
                ...
                (v.prototype.tick = function () {
                  ...
                  if (this.isGrowthFinished) {
                    ...
                    (this.afterGrowthIterations % 10 == 0 &&
                      ...
                      (this.coolingFactor =
                        l.DEFAULT_COOLING_FACTOR_INCREMENTAL *
                ...
                (v.prototype.runSpringEmbedder = function () {
                  ...
                  var t = !1;
                  if ('during' === l.ANIMATE) this.emit('layoutstarted');
                  else {
                    for (; !t;) t = this.tick();
                    this.graphManager.updateBounds();
                  }
                    ...
                    if (!e.has(i)) {
                      ...
                      if (r == n)
                        ...
                        var o,
                          ...
                          a = [];
                        if (
                          ((a = (a = a.concat(r.getEdgeListToNode(n))).concat(
                ...
                (v.prototype.positionNodesRadially = function (t) {
                  for (
                    var e = new u(0, 0),
                    ...
                    a % i == 0 &&
                      ((o = 0), (n = r), 0 != a && (n += h.DEFAULT_COMPONENT_SEPERATION), (r = 0));
                    var l = t[a],
                      p = d.findCenterOfTree(l);
                    ((e.x = o),
                      (e.y = n),
                      (s = v.radialLayout(l, p, e)).y > r && (r = Math.floor(s.y)),
                      (o = Math.floor(s.x + h.DEFAULT_COMPONENT_SEPERATION)));
                  }
                  this.transform(new c(g.WORLD_CENTER_X - s.x / 2, g.WORLD_CENTER_Y - s.y / 2));
                }),
                (v.radialLayout = function (t, e, i) {
                  var r = Math.max(this.maxDiagonalInTree(t), h.DEFAULT_RADIAL_SEPARATION);
                  v.branchRadialLayout(e, null, 0, 359, 0, r);
                  ...
                  var a = new c(n.getMaxX(), n.getMaxY());
                  return o.inverseTransformPoint(a);
                }),
                (v.branchRadialLayout = function (t, e, i, r, n, o) {
                  var s,
                    a = (r - i + 1) / 2;
                  a < 0 && (a += 180);
                  var h = (((a + i) % 360) * f.TWO_PI) / 360,
                    l = n * Math.cos(h),
                    g = n * Math.sin(h);
                  t.setCenter(l, g);
                  var u = [],
                    c = (u = u.concat(t.getEdges())).length;
                  null != e && c--;
                  for (var d = 0, p = u.length, y = t.getEdgesBetween(e); y.length > 1;) {
                    var E = y[0];
                    y.splice(0, 1);
                    var A = u.indexOf(E);
                    (A >= 0 && u.splice(A, 1), p--, c--);
                  }
                  s = null != e ? (u.indexOf(y[0]) + 1) % p : 0;
                  for (var T = Math.abs(r - i) / c, N = s; d != c; N = ++N % p) {
                    var _ = u[N].getOtherEnd(t);
                    if (_ != e) {
                      var L = (i + d * T) % 360,
                        m = (L + T) % 360;
                      (v.branchRadialLayout(_, t, L, m, n + o, o), d++);
                    }
                  }
                }),
                (v.maxDiagonalInTree = function (t) {
                  for (var e = p.MIN_VALUE, i = 0; i < t.length; i++) {
                ...
                (v.prototype.groupZeroDegreeMembers = function () {
                  ...
                  for (var i = [], r = this.graphManager.getAllNodes(), n = 0; n < r.length; n++) {
                    ...
                    0 !== this.getNodeDegreeWithChildren(o) ||
                      (void 0 != a.id && this.getToBeTiled(a)) ||
                      i.push(o);
                  }
                ...
                (v.prototype.getToBeTiled = function (t) {
                  var e = t.id;
                ...
                (v.prototype.getNodeDegree = function (t) {
                  t.id;
                ...
                (v.prototype.getNodeDegreeWithChildren = function (t) {
                ...
                (v.prototype.fillCompexOrderByDFS = function (t) {
                  for (var e = 0; e < t.length; e++) {
                    var i = t[e];
                ...
                (v.prototype.adjustLocations = function (t, e, i, r, n) {
                  ((e += r), (i += n));
                  for (var o = e, s = 0; s < t.rows.length; s++) {
                    ...
                    for (var h = 0, l = 0; l < a.length; l++) {
                      ...
                      ((g.rect.x = e),
                        (g.rect.y = i),
                        (e += g.rect.width + t.horizontalPadding),
                        g.rect.height > h && (h = g.rect.height));
                    }
                    i += h + t.verticalPadding;
                  }
                }),
                (v.prototype.tileCompoundMembers = function (t, e) {
                  var i = this;
                ...
                (v.prototype.tileNodes = function (t, e) {
                  var i = {
                    rows: [],
                    rowWidth: [],
                    rowHeight: [],
                  ...
                  t.sort(function (t, e) {
                    return t.rect.width * t.rect.height > e.rect.width * e.rect.height
                      ? -1
                      : +(t.rect.width * t.rect.height < e.rect.width * e.rect.height);
                  });
                  for (var r = 0; r < t.length; r++) {
                    var n = t[r];
                    (0 == i.rows.length
                      ? this.insertNodeToRow(i, n, 0, e)
                      : this.canAddHorizontal(i, n.rect.width, n.rect.height)
                        ? this.insertNodeToRow(i, n, this.getShortestRowIndex(i), e)
                        : this.insertNodeToRow(i, n, i.rows.length, e),
                      this.shiftToLastRow(i));
                  }
                  return i;
                }),
                (v.prototype.insertNodeToRow = function (t, e, i, r) {
                  ...
                  var s = 0;
                  (o > t.rowHeight[i] &&
                    ((s = t.rowHeight[i]), (t.rowHeight[i] = o), (s = t.rowHeight[i] - s)),
                    (t.height += s),
                    t.rows[i].push(e));
                }),
                (v.prototype.getShortestRowIndex = function (t) {
                  for (var e = -1, i = Number.MAX_VALUE, r = 0; r < t.rows.length; r++)
                    t.rowWidth[r] < i && ((e = r), (i = t.rowWidth[r]));
                  return e;
                }),
                (v.prototype.getLongestRowIndex = function (t) {
                  for (var e = -1, i = 5e-324, r = 0; r < t.rows.length; r++)
                    t.rowWidth[r] > i && ((e = r), (i = t.rowWidth[r]));
                  return e;
                }),
                (v.prototype.canAddHorizontal = function (t, e, i) {
                  var r,
                    n,
                    o = this.getShortestRowIndex(t);
                  if (o < 0) return !0;
                  var s = t.rowWidth[o];
                  if (s + t.horizontalPadding + e <= t.width) return !0;
                  var a = 0;
                  return (
                    t.rowHeight[o] < i && o > 0 && (a = i + t.verticalPadding - t.rowHeight[o]),
                    (r =
                      t.width - s >= e + t.horizontalPadding
                        ? (t.height + a) / (s + e + t.horizontalPadding)
                        : (t.height + a) / t.width),
                    (a = i + t.verticalPadding),
                    (n = t.width < e ? (t.height + a) / e : (t.height + a) / t.width) < 1 &&
                      (n = 1 / n),
                    r < 1 && (r = 1 / r),
                    r < n
                  );
                }),
                (v.prototype.shiftToLastRow = function (t) {
                  ...
                  if (t.width - t.rowWidth[i] > o && e != i) {
                    ...
                    for (var s = 5e-324, a = 0; a < r.length; a++)
                  ...
                  for (var t, e = [], i = !0; i;) {
                    ...
                    for (var o = 0; o < r.length; o++)
                      1 != (t = r[o]).getEdges().length ||
                        ...
                        null != t.getChild() ||
                        (n.push([t, t.getEdges()[0], t.getOwner()]), (i = !0));
                    if (!0 == i) {
                      for (var s = [], a = 0; a < n.length; a++)
                        1 == n[a][0].getEdges().length &&
                          (s.push(n[a]), n[a][0].getOwner().remove(n[a][0]));
                      (e.push(s),
                ...
                (v.prototype.growTree = function (t) {
                ...
                (v.prototype.findPlaceforPrunedNode = function (t) {
                  var e,
                    i,
                    r,
                    n,
                    o = t[0],
                    s = (i = o == t[1].source ? t[1].target : t[1].source).startX,
                    a = i.finishX,
                    h = i.startY,
                    g = i.finishY,
                    u = [0, 0, 0, 0];
                  if (h > 0)
                    for (var c = s; c <= a; c++)
                      u[0] += this.grid[c][h - 1].length + this.grid[c][h].length - 1;
                  if (a < this.grid.length - 1)
                    for (var c = h; c <= g; c++)
                      u[1] += this.grid[a + 1][c].length + this.grid[a][c].length - 1;
                  if (g < this.grid[0].length - 1)
                    for (var c = s; c <= a; c++)
                      u[2] += this.grid[c][g + 1].length + this.grid[c][g].length - 1;
                  if (s > 0)
                    for (var c = h; c <= g; c++)
                      u[3] += this.grid[s - 1][c].length + this.grid[s][c].length - 1;
                  for (var d = p.MAX_VALUE, f = 0; f < u.length; f++)
                    u[f] < d ? ((d = u[f]), (r = 1), (n = f)) : u[f] == d && r++;
                  if (3 == r && 0 == d)
                    0 == u[0] && 0 == u[1] && 0 == u[2]
                      ? (e = 1)
                      : 0 == u[0] && 0 == u[1] && 0 == u[3]
    ...
    (t.e,
      (e.exports = (function (t) {
        var e = [
            ...
            function (t, e, i) {
              'use strict';
              var r = i(0).layoutBase.LayoutConstants,
                n = i(0).layoutBase.FDLayoutConstants,
                o = i(0).CoSEConstants,
                s = i(0).CoSELayout,
                a = i(0).CoSENode,
                h = i(0).layoutBase.PointD,
                l = i(0).layoutBase.DimensionD,
                g = {
                  ready: function () {},
                  stop: function () {},
                  quality: 'default',
              ...
              var c = function (t) {
                (null != t.nodeRepulsion &&
                  (o.DEFAULT_REPULSION_STRENGTH = n.DEFAULT_REPULSION_STRENGTH = t.nodeRepulsion),
                  null != t.idealEdgeLength &&
                    (o.DEFAULT_EDGE_LENGTH = n.DEFAULT_EDGE_LENGTH = t.idealEdgeLength),
                  null != t.edgeElasticity &&
                    (o.DEFAULT_SPRING_STRENGTH = n.DEFAULT_SPRING_STRENGTH = t.edgeElasticity),
                  null != t.nestingFactor &&
                    (o.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = n.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      t.nestingFactor),
                  null != t.gravity &&
                    (o.DEFAULT_GRAVITY_STRENGTH = n.DEFAULT_GRAVITY_STRENGTH = t.gravity),
                  null != t.numIter && (o.MAX_ITERATIONS = n.MAX_ITERATIONS = t.numIter),
                  null != t.gravityRange &&
                    (o.DEFAULT_GRAVITY_RANGE_FACTOR = n.DEFAULT_GRAVITY_RANGE_FACTOR =
                      t.gravityRange),
                  null != t.gravityCompound &&
                    (o.DEFAULT_COMPOUND_GRAVITY_STRENGTH = n.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                      t.gravityCompound),
                  null != t.gravityRangeCompound &&
                    (o.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                      n.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                        t.gravityRangeCompound),
                  null != t.initialEnergyOnIncremental &&
                    (o.DEFAULT_COOLING_FACTOR_INCREMENTAL = n.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                  ...
                  (o.DEFAULT_INCREMENTAL =
                    n.DEFAULT_INCREMENTAL =
                    r.DEFAULT_INCREMENTAL =
                      !t.randomize),
                  (o.ANIMATE = n.ANIMATE = r.ANIMATE = t.animate),
                  (o.TILE = t.tile),
                  (o.TILING_PADDING_VERTICAL =
              ...
              ((u.prototype.run = function () {
                var t,
                  ...
                  i = this.options;
                this.idToLNode = {};
                var r = (this.layout = new s()),
                  n = this;
                ((n.stopped = !1),
                  (this.cy = this.options.cy),
                  this.cy.trigger({ type: 'layoutstart', layout: this }));
                var o = r.newGraphManager();
                this.gm = o;
                var a = this.options.eles.nodes(),
                  h = this.options.eles.edges();
                ((this.root = o.addRoot()),
                  this.processChildrenList(this.root, this.getTopMostNodes(a), r));
                for (var l = 0; l < h.length; l++) {
                  var g = h[l],
                    u = this.idToLNode[g.data('source')],
                    c = this.idToLNode[g.data('target')];
                  u !== c &&
                    0 == u.getEdgesBetween(c).length &&
                    (o.add(r.newEdge(), u, c).id = g.id());
                }
                var d = function (t, e) {
                    'number' == typeof t && (t = e);
                    var i = t.data('id'),
                      r = n.idToLNode[i];
                    return { x: r.getRect().getCenterX(), y: r.getRect().getCenterY() };
                  },
                  p = function o() {
                    for (
                      var s,
                        a = function () {
                          (i.fit && i.cy.fit(i.eles, i.padding),
                            t ||
                              ((t = !0),
                              n.cy.one('layoutready', i.ready),
                      ...
                      s = n.stopped || n.layout.tick();
                    if (s) {
                      (r.checkLayoutSuccess() && !r.isSubLayout && r.doPostLayout(),
                        r.tilingPostLayout && r.tilingPostLayout(),
                        (r.isLayoutFinished = !0),
                        n.options.eles.nodes().positions(d),
                        a(),
                    ...
                    var g = n.layout.getPositionsData();
                    (i.eles.nodes().positions(function (t, e) {
                      if (('number' == typeof t && (t = e), !t.isParent())) {
                        for (
                          var i = t.id(), r = g[i], n = t;
                          null == r &&
                          ((r = g[n.data('parent')] || g['DummyCompound_' + n.data('parent')]),
                          (g[i] = r),
                          void 0 != (n = n.parent()[0]));
                        );
                        return null != r
                ...
                return (
                  r.addListener('layoutstarted', function () {
                    'during' === n.options.animate && (e = requestAnimationFrame(p));
                  }),
                  r.runLayout(),
                  'during' !== this.options.animate &&
                    (n.options.eles.nodes().not(':parent').layoutPositions(n, n.options, d),
                    (t = !1)),
                  this
                );
              }),
                ...
                (u.prototype.processChildrenList = function (t, e, i) {
                  for (var r = e.length, n = 0; n < r; n++) {
                    var o,
                      s,
                      g = e[n],
                      u = g.children(),
                      c = g.layoutDimensions({
                        nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels,
                      });
                    if (
                      (((o =
                        null != g.outerWidth() && null != g.outerHeight()
                          ? t.add(
                              new a(
                                i.graphManager,
                                new h(g.position('x') - c.w / 2, g.position('y') - c.h / 2),
                                new l(parseFloat(c.w), parseFloat(c.h)),
                              ),
                            )
                          : t.add(new a(this.graphManager))).id = g.data('id')),
                      (o.paddingLeft = parseInt(g.css('padding'))),
                      (o.paddingTop = parseInt(g.css('padding'))),
                      (o.paddingRight = parseInt(g.css('padding'))),
                      (o.paddingBottom = parseInt(g.css('padding'))),
                      this.options.nodeDimensionsIncludeLabels && g.isParent())
                    ) {
                      var d = g.boundingBox({ includeLabels: !0, includeNodes: !1 }).w,
                        p = g.boundingBox({ includeLabels: !0, includeNodes: !1 }).h,
                        f = g.css('text-halign');
                      ((o.labelWidth = d), (o.labelHeight = p), (o.labelPos = f));
                    }
                    ((this.idToLNode[g.data('id')] = o),
                      isNaN(o.rect.x) && (o.rect.x = 0),
                      isNaN(o.rect.y) && (o.rect.y = 0),
                      null != u &&
                        u.length > 0 &&
                        ((s = i.getGraphManager().add(i.newGraph(), o)),
                        this.processChildrenList(s, u, i)));
                  }
                }),
              ...
              var d = function (t) {
                t('layout', 'cose-bilkent', u);
              };
              ('u' > typeof cytoscape && d(cytoscape), (t.exports = d));
            },
          ],
          i = {};
        function r(t) {
  ...
  (t) => {
    ...
    function s(t, e) {
      t.forEach((t) => {
        ...
        (Object.keys(t).forEach((e) => {
          ['id', 'label', 'height', 'width', 'padding', 'x', 'y'].includes(e) || (i[e] = t[e]);
        }),
          e.add({ group: 'nodes', data: i, position: { x: t.x ?? 0, y: t.y ?? 0 } }));
      });
    }
    function a(t, e) {
      t.forEach((t) => {
        let i = { id: t.id, source: t.start, target: t.end };
        (Object.keys(t).forEach((e) => {
          ['id', 'start', 'end'].includes(e) || (i[e] = t[e]);
        }),
          e.add({ group: 'edges', data: i }));
      });
    }
    function h(t) {
      return new Promise((i) => {
        let n = (0, o.select)('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
          h = (0, r.default)({
        ...
        (n.remove(),
          ...
          h.layout({ name: 'cose-bilkent', quality: 'proof', styleEnabled: !1, animate: !1 }).run(),
          h.ready((t) => {
            (e.log.info('Cytoscape ready', t), i(h));
          }));
      });
    }
    function l(t) {
    ...
    function g(t) {
      return t.edges().map((t) => {
        ...
        return (
          Object.keys(e).forEach((t) => {
            ['id', 'source', 'target'].includes(t) || (r[t] = e[t]);
          }),
          r
        );
      });
    ...
    async function u(t, i) {
      e.log.debug('Starting cose-bilkent layout algorithm');
      try {
        c(t);
        let i = await h(t),
          r = l(i),
          n = g(i);
        return (
          e.log.debug(`Layout completed: ${r.length} nodes, ${n.length} edges`),
          { nodes: r, edges: n }
        );
      } catch (t) {
        throw (e.log.error('Error in cose-bilkent layout algorithm:', t), t);
      }
    }
    function c(t) {
    ...
    (r.default.use(n.default),
      (0, i.__name)(s, 'addNodes'),
      (0, i.__name)(a, 'addEdges'),
      (0, i.__name)(h, 'createCytoscapeInstance'),
      (0, i.__name)(l, 'extractPositionedNodes'),
      (0, i.__name)(g, 'extractPositionedEdges'),
      (0, i.__name)(u, 'executeCoseBilkentLayout'),
      (0, i.__name)(c, 'validateLayoutData'));
    var d = (0, i.__name)(
      async (
        t,
        e,
        ...
        let p = d.insert('g').attr('class', 'subgraphs'),
          f = d.insert('g').attr('class', 'edgePaths'),
          y = d.insert('g').attr('class', 'edgeLabels'),
          E = d.insert('g').attr('class', 'nodes');
        (a.debug('Inserting nodes into DOM for dimension calculation'),
          await Promise.all(
            t.nodes.map(async (e) => {
              if (e.isGroup) {
                let t = { ...e };
                ((c[e.id] = t), (g[e.id] = t), await i(p, e));
              } else {
                let i = { ...e };
                g[e.id] = i;
                let r = await s(E, e, { config: t.config, dir: t.direction || 'TB' }),
                  n = r.node().getBBox();
                ((i.width = n.width),
                  (i.height = n.height),
                  (i.domId = r),
                  a.debug(`Node ${e.id} dimensions: ${n.width}x${n.height}`));
              }
            }),
          ),
        ...
        let v = {
            ...
            nodes: t.nodes.map((t) => {
              let e = g[t.id];
              return { ...t, width: e.width, height: e.height };
            }),
          },
          A = await u(v, t.config);
        (a.debug('Positioning nodes based on layout results'),
          A.nodes.forEach((t) => {
            let e = g[t.id];
            e?.domId &&
              (e.domId.attr('transform', `translate(${t.x}, ${t.y})`),
              (e.x = t.x),
              (e.y = t.y),
              a.debug(`Positioned node ${e.id} at center (${t.x}, ${t.y})`));
          }),
          A.edges.forEach((e) => {
          ...
          a.debug('Inserting and positioning edges'),
          await Promise.all(
            t.edges.map(async (e) => {
              await n(y, e);
              let i = g[e.start ?? ''],
              ...
              if (i && o) {
                ...
                if (n) {
                  ...
                  let s = { ...e },
                    l = r(f, s, c, t.type, i, o, t.diagramId);
                  h(s, l);
                } else {
                  let n = {
                      ...e,
                    ...
                    s = r(f, n, c, t.type, i, o, t.diagramId);
                  h(n, s);
                }
              }
            }),
