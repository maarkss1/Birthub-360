...
export function Sidebar({
  ...
  const navGroupsByJourney: NavGroupDefinition[] = isRestrictedSdrProfile
    ? [
        { title: '🎛️ Painel de Controle', items: ['daily-plan'] },
        { title: '🎯 Prospecção', items: ['prospect'] },
        {
        ...
        { title: '🤝 Engajamento', items: ['activities', 'calendar', 'cadence'] },
        {
          title: '🧠 Central de IA & Treinamento',
          items: ['roleplay', 'objections_matrix', 'chatbook', 'topic_training'],
        },
        { title: '⚙️ Configurações & Gestão', items: ['notifications', 'bitrix', 'settings'] },
      ]
    : [
        {
        ...
        { title: '🎯 Prospecção', items: ['prospect', 'market-intelligence'] },
        {
          title: '⚖️ Qualificação',
          items: [
            'companies',
        ...
        { title: '🤝 Engajamento', items: ['activities', 'calendar', 'cadence'] },
        { title: '💼 Negociação & Vendas', items: ['crm', 'crm360', 'propostas'] },
        { title: '📈 Inteligência & Resultados', items: analyzeItems },
        {
          title: '🧠 Central de IA & Treinamento',
          items: [
        ...
        { title: '⚙️ Configurações & Gestão', items: administrationItems },
      ];
  ...
  const GROUP_ORDER_BY_ROLE: Partial<Record<string, string[]>> = {
    CLOSER: [
      ...
      '⚖️ Qualificação',
      '🎯 Prospecção',
      '📈 Inteligência & Resultados',
      '🧠 Central de IA & Treinamento',
