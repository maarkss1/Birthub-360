    ...
    >
      ...
      {actionLabel && onAction && (
        <button
          type="button"
          onClick={onAction}
          className="mt-5 rounded-full border border-line bg-surface-2 px-4 py-2 text-xs font-bold uppercase tracking-wide text-ink-2 transition-colors hover:bg-brand/10 hover:text-brand-active focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
        >
          {actionLabel}
        </button>
      )}
