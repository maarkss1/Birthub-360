...
const TECH_DATABASE: Record<string, TechToolInfo> = {
  ...
  aws: {
    ...
    bgColor: '#251A08',
    borderColor: '#52340B',
    description: 'Nuvem e infraestrutura em escala global',
  },
  amazon: {
    name: 'AWS',
    category: 'Cloud',
    ...
    bgColor: '#251A08',
    borderColor: '#52340B',
    description: 'Nuvem e infraestrutura Amazon Web Services',
  },
  salesforce: {
    name: 'Salesforce',
    category: 'CRM',
    ...
    bgColor: '#052233',
    borderColor: '#0E4968',
    description: 'Plataforma líder em gestão de relacionamento e CRM',
  },
  hubspot: {
    name: 'HubSpot',
    category: 'CRM',
    ...
    bgColor: '#2B140D',
    borderColor: '#5E2718',
    description: 'CRM de Inbound Marketing e Vendas',
  },
  wordpress: {
    name: 'WordPress',
    category: 'Frontend',
    ...
    bgColor: '#081720',
    borderColor: '#10374D',
    description: 'CMS e gerenciador de conteúdo web',
  },
  shopify: {
    name: 'Shopify',
    category: 'E-commerce',
    ...
    bgColor: '#10210A',
    borderColor: '#294B1B',
    description: 'Plataforma de E-commerce e lojas virtuais',
  },
  googleanalytics: {
    ...
    bgColor: '#2B0E0B',
    borderColor: '#5B1F19',
    description: 'Análise de tráfego e comportamento de usuários',
  },
  gtm: {
    ...
    bgColor: '#0C1A30',
    borderColor: '#183664',
    description: 'Gerenciador de tags e mensuração web',
  },
  sap: {
    name: 'SAP',
    category: 'CRM',
    ...
    bgColor: '#051D2A',
    borderColor: '#0B425F',
    description: 'ERP corporativo e sistemas de gestão integrada',
  },
  docker: {
    name: 'Docker',
    category: 'DevOps',
    ...
    bgColor: '#091D2E',
    borderColor: '#124168',
    description: 'Contêineres de aplicação para implantação ágil',
  },
  kubernetes: {
    name: 'Kubernetes',
    category: 'DevOps',
    ...
    bgColor: '#0B1630',
    borderColor: '#162F64',
    description: 'Orquestrador de microsserviços em contêiner',
  },
  python: {
    name: 'Python',
    category: 'Backend',
    ...
    bgColor: '#0A1824',
    borderColor: '#15354F',
    description: 'Linguagem de programação para backend e IA',
  },
  nodejs: {
    name: 'Node.js',
    category: 'Backend',
    ...
    bgColor: '#081D08',
    borderColor: '#144314',
    description: 'Runtime Javascript assíncrono para servidores',
  },
  node: {
    name: 'Node.js',
    category: 'Backend',
  ...
  postgresql: {
    ...
    bgColor: '#0C142B',
    borderColor: '#1B2C5C',
    description: 'Banco de dados relacional avançado open-source',
  },
  postgres: {
    name: 'PostgreSQL',
    category: 'Database',
  ...
  redis: {
    ...
    bgColor: '#280A08',
    borderColor: '#5C1713',
    description: 'Banco em memória para cache e altíssima performance',
  },
  zendesk: {
    name: 'Zendesk',
    category: 'CRM',
    ...
    bgColor: '#021B1F',
    borderColor: '#06424B',
    description: 'Plataforma de suporte ao cliente e helpdesk',
  },
  mailchimp: {
    name: 'Mailchimp',
    category: 'Marketing',
  ...
  stripe: {
    ...
    bgColor: '#141236',
    borderColor: '#2E2A78',
    description: 'Infraestrutura de pagamentos e cobrança online',
  },
  slack: {
    name: 'Slack',
    category: 'Outros',
    ...
    bgColor: '#1A061B',
    borderColor: '#400E42',
    description: 'Comunicação interna e colaboração corporativa',
  },
  jira: {
    name: 'Jira',
    category: 'Outros',
    ...
    bgColor: '#04132B',
    borderColor: '#082C63',
    description: 'Gestão de projetos e equipes ágeis da Atlassian',
  },
  cloudflare: {
    name: 'Cloudflare',
    category: 'Cloud',
    ...
    bgColor: '#2A1605',
    borderColor: '#5C310B',
    description: 'CDN, segurança contra DDoS e otimização DNS',
  },
  azure: {
  ...
  vue: {
    ...
    bgColor: '#0B2117',
    borderColor: '#194A34',
    description: 'Framework progressivo para interfaces web',
  },
  angular: {
    name: 'Angular',
    category: 'Frontend',
    ...
    bgColor: '#290008',
    borderColor: '#5C0015',
    description: 'Framework frontend corporativo do Google',
  },
  nextjs: {
    name: 'Next.js',
    category: 'Frontend',
    ...
    bgColor: '#171717',
    borderColor: '#333333',
    description: 'Framework React com SSR e renderização híbrida',
  },
  next: {
    name: 'Next.js',
    category: 'Frontend',
  ...
  pipedrive: {
    ...
    bgColor: '#141414',
    borderColor: '#333333',
    description: 'CRM de vendas e funil de prospecção',
  },
  activecampaign: {
    name: 'ActiveCampaign',
    category: 'Marketing',
    ...
    bgColor: '#0A1530',
    borderColor: '#162F66',
    description: 'Automação de e-mail e experiência do cliente',
  },
  rdstation: {
    name: 'RD Station',
    category: 'Marketing',
    ...
    bgColor: '#00261D',
    borderColor: '#005743',
    description: 'Automação de Marketing Digital líder no Brasil',
  },
  totvs: {
    name: 'TOTVS',
    category: 'CRM',
    ...
    bgColor: '#001424',
    borderColor: '#00375E',
    description: 'ERP e sistemas integrados de gestão empresarial',
  },
  oracle: {
    name: 'Oracle',
    category: 'Database',
    ...
    bgColor: '#290000',
    borderColor: '#5E0000',
    description: 'Banco de dados corporativo de alto desempenho',
  },
  mysql: {
    name: 'MySQL',
    category: 'Database',
    ...
    bgColor: '#0D171F',
    borderColor: '#1D3547',
    description: 'Sistema gerenciador de banco de dados open source',
  },
  mongodb: {
    name: 'MongoDB',
    category: 'Database',
  ...
  intercom: {
    ...
    bgColor: '#071B2D',
    borderColor: '#103F68',
    description: 'Mensageria e atendimento ao cliente',
  },
  hotjar: {
    name: 'Hotjar',
    category: 'Analytics',
    ...
    bgColor: '#2B0A00',
    borderColor: '#5E1600',
    description: 'Mapas de calor e análise de experiência do usuário',
  },
};
...
export const TechToolLogo: React.FC<TechToolLogoProps> = ({
  ...
  return (
    ...
    >
      ...
      <span className="tracking-tight text-white/90 group-hover:text-white font-medium">
        {info.name}
      </span>
      {showCategory && (
