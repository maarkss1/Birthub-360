...
/**
 * Componente adicionado via integração de componente externo (registry-style, ex. 21st.dev).
 * Mantido próximo do original pedido — NÃO usa os tokens de marca deste projeto (--brand,
 * --bg/--surface/--ink) nem o gradiente laranja/roxo-proibido é evitado aqui por regra da
 * Constituição (.claude/CLAUDE.md §4.3: "sem gradiente azul/roxo genérico"). Este arquivo é um
 * primitivo de UI isolado para preview/demo — não está roteado em src/App.tsx e não substitui a
 * tela de login real do produto (`src/features/auth/components/LoginScreen.tsx`), que já resolve
 * marca, tema, 2FA e integração com o backend de auth. Veja sign-in-page.demo.tsx para o preview.
 */
    ...
    <div className="h-screen w-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            // Asset de exemplo do 21st.dev trocado por um Unsplash estável (o CDN original é de
            // preview de componente, não uma URL destinada a uso em produção).
        ...
        <div className="w-full max-w-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                {/* GitHub SVG */}
                <svg className="w-5 h-5 mr-2" fill="#24292f" viewBox="0 0 24 24" aria-hidden="true">
