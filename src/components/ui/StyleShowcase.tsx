      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <HolographicCard variant="purple" intensity="medium">
            ...
            <CyberInput variant="neon" glowColor="cyan" placeholder="Digite algo..." className="mb-2" />
          </HolographicCard>
        </motion.div>
          ...
          <HolographicCard variant="gold" intensity="low">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-sm text-ink-2 uppercase tracking-wider">Toggles</h4>
                <Toggle checked label="Modo Clássico" variant="classic" />
                <Toggle checked label="Modo Neon" variant="neon" glowColor="cyan" />
                <Toggle checked label="Modo Cyber" variant="cyber" glowColor="purple" />
              </div>

              {/* Inputs */}
              <div className="space-y-4">
                <h4 className="font-semibold text-sm text-ink-2 uppercase tracking-wider">Inputs</h4>
              ...
              {/* Botões */}
              <div className="space-y-4">
                <h4 className="font-semibold text-sm text-ink-2 uppercase tracking-wider">Botões</h4>
                <div className="flex flex-wrap gap-2">
                  <NeonButton variant="cyan" size="sm">Cyan</NeonButton>
                  <NeonButton variant="purple" size="sm">Purple</NeonButton>
                  <NeonButton variant="gold" size="sm">Gold</NeonButton>
                  <NeonButton variant="pink" size="sm">Pink</NeonButton>
                  <NeonButton variant="green" size="sm">Green</NeonButton>
                </div>
              </div>
            </div>
          </HolographicCard>
