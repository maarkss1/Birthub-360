...
/**
 * Biblioteca de ícones própria da plataforma.
 * Grid 24x24, traço 1.75, cantos arredondados — geometria circular contínua,
 * ecoando o anel e a órbita do emblema Birth Hub 360.
 * Uso: <IconHome className="w-5 h-5" />
 */
export type BrandIconProps = SVGProps<SVGSVGElement>;

function base(props: BrandIconProps) {
  return {
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
...
export function IconBuilding(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconContacts(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconPipeline(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconActivity(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconRadar(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconSparkle(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M12 3.5c.5 3.2 1.4 4.9 2.9 6.4 1.5 1.5 3.2 2.4 6.4 2.9-3.2.5-4.9 1.4-6.4 2.9-1.5 1.5-2.4 3.2-2.9 6.4-.5-3.2-1.4-4.9-2.9-6.4C7.6 14.1 5.9 13.2 2.7 12.7c3.2-.5 4.9-1.4 6.4-2.9 1.5-1.5 2.4-3.2 2.9-6.3Z"
...
export function IconSearch(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconBell(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconChevronsLeft(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconArrowRight(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path d="M4.5 12h14.5" />
...
export function IconCheck(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconBolt(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M13 3 5.5 13.2a.7.7 0 0 0 .56 1.1H11l-1 6.7 7.9-10.6a.7.7 0 0 0-.56-1.1H13Z"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconLogout(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconClock(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="8.5" />
...
export function IconMenu(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconTrendUp(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconPhone(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M6.3 4h2.4l1.3 3.6-1.7 1.5a11.5 11.5 0 0 0 5.1 5.1l1.5-1.7L18.4 14v2.4a1.4 1.4 0 0 1-1.5 1.4A14.5 14.5 0 0 1 5 6.1 1.4 1.4 0 0 1 6.3 4Z"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconHandshake(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconTrophy(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconClose(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconFlame(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M12 3.5c2 2.3 1 3.8.5 5-1 2.4-3 2.7-3 5A2.5 2.5 0 0 0 12 16a2 2 0 0 0 2-2.3c1.2.9 1.8 2 1.8 3.3A3.8 3.8 0 0 1 12 20.5a5.3 5.3 0 0 1-5.3-5.3c0-3.2 2-4.5 3.3-6.7.9-1.5 1.3-3 2-5Z"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconSnowflake(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconDownload(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconPlus(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconEdit(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M4 20h4.2L18.4 9.8a2 2 0 0 0 0-2.8l-1.4-1.4a2 2 0 0 0-2.8 0L4 15.8Z"
        strokeLinejoin="round"
      />
...
export function IconMail(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconMapPin(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconSpinner(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconArrowLeft(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path d="M19.5 12H5" />
...
export function IconGlobe(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="8.5" />
...
export function IconTwitterX(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconFacebook(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M14.5 21v-7.5H17l.5-3.3h-3V8.1c0-1 .3-1.7 1.7-1.7H17.7V3.5A22 22 0 0 0 15.5 3.4c-2.4 0-4 1.5-4 4.1v2.7H8.9v3.3h2.6V21"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconStar(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M12 3.7l2.5 5.2 5.6.8-4 4 1 5.7-5.1-2.7-5.1 2.7 1-5.7-4-4 5.6-.8Z"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconTag(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M11.6 3.5H6a1 1 0 0 0-1 1v5.6a1 1 0 0 0 .3.7l9 9a1 1 0 0 0 1.4 0l5.6-5.6a1 1 0 0 0 0-1.4l-9-9a1 1 0 0 0-.7-.3Z"
        strokeLinejoin="round"
      />
...
export function IconWrench(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M14.5 3.8a4.5 4.5 0 0 0-5.7 5.3L4 13.9v3.2h3.2l4.8-4.8a4.5 4.5 0 0 0 5.3-5.7l-3.1 3.1-2.3-.6-.6-2.3Z"
        strokeLinejoin="round"
      />
    </svg>
  );
...
export function IconClipboard(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconChevronDown(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconChevronUp(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconSend(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconSave(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M5 4.5h11l3 3V19a.5.5 0 0 1-.5.5H5a.5.5 0 0 1-.5-.5V5a.5.5 0 0 1 .5-.5Z"
        strokeLinejoin="round"
      />
...
export function IconInfo(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="8.5" />
      <path d="M12 11v5.5" />
...
export function IconMessage(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
...
export function IconCalendar(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconChat(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M4 5.5h16v10.5a1 1 0 0 1-1 1H9l-4 3.5v-3.5H5a1 1 0 0 1-1-1Z"
...
export function IconDatabase(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconCpu(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconBot(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconServer(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconWarning(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <path
        d="M10.6 3.9 2.9 18a1.4 1.4 0 0 0 1.2 2.1h15.8a1.4 1.4 0 0 0 1.2-2.1L13.4 3.9a1.4 1.4 0 0 0-2.8 0Z"
        strokeLinejoin="round"
      />
      <path d="M12 9.3v4.4" />
...
export function IconLandmark(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconUserPlus(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconDollar(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="8.5" />
      <path d="M12 6.5v11" />
...
export function IconBook(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconAlertTriangle(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconHelp(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconFilter(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconZap(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconCode(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconLayers(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
...
export function IconRefresh(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
