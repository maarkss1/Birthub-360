...
import { createSwarmSchedulerWorker, scheduleSwarmScheduler } from '../lib/queue/swarmScheduler.worker.js';
...
import { createFollowUpWorker, scheduleFollowUpJobs } from '../features/crm/jobs/followUp.worker.js';
import { createExecutiveSummaryWorker, scheduleExecutiveSummaryJob } from '../features/crm/jobs/dailyExecutiveSummary.worker.js';
import { createDeduplicationWorker, scheduleDeduplicationJob } from '../features/crm/jobs/deduplication.worker.js';
import { accountIntelligenceSchedulerQueue, createAccountIntelligenceSchedulerWorker } from '../features/market-intelligence/jobs/accountIntelligenceScheduler.worker.js';
import { createWinLossAnalysisWorker, scheduleWinLossAnalysisJob } from '../features/intelligence/services/winLossAnalysis.worker.js';
import { createWeeklyPdfReportWorker, scheduleWeeklyPdfReportJob } from '../features/crm/jobs/weeklyPdfReport.worker.js';
import { createAutoAnonymizeWorker, scheduleAutoAnonymizeJob } from '../features/crm/jobs/autoAnonymizeDisqualified.worker.js';
import { createColdLeadsScannerWorker, scheduleColdLeadsScannerJob } from '../features/automations/application/cold-leads-scanner.service.js';
import { createStagnationScannerWorker, scheduleStagnationScannerJob } from '../features/automations/application/stagnation-scanner.service.js';
import { createCadenceRunWorker, scheduleCadenceRunJob } from '../features/cadence/jobs/cadenceRun.worker.js';
import { MeetingSynthesisService } from '../features/chatbook/services/meeting-synthesis.service.js';
import { createForecastSnapshotWorker, scheduleForecastSnapshotJob } from '../features/commercial-intelligence/jobs/forecastSnapshotWeekly.worker.js';
import { createCopilotoTranscriptionWorker } from '../features/copiloto-ia/jobs/transcribeConversation.worker.js';
import { createAgentMemoryCleanupWorker, scheduleAgentMemoryCleanupJob } from '../features/intelligence/jobs/agentMemoryCleanup.worker.js';
import { createAccountIntelligenceInsightsWorker, scheduleAccountIntelligenceInsightsJob } from '../features/market-intelligence/jobs/accountIntelligenceInsights.worker.js';
import { createNewsMonitorWorker, scheduleGlobalNewsScan } from '../lib/queue/newsMonitor.worker.js';
