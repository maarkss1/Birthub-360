...
export const ATLAS_PERSONA_OPTIONS = [
  {
    label: 'Dono / CEO',
    nivel: 'Decisor final',
    titles: 'CEO,Dono,Diretor Presidente,Diretor Geral',
    seniorities: ['c_suite'],
  },
  {
    label: 'Diretor de Operações / COO',
    nivel: 'Decisor final',
    titles: 'Diretor de Operações,COO,Diretor Operacional',
    seniorities: ['c_suite'],
  },
  {
    label: 'Diretor de Logística / Supply',
    nivel: 'Decisor final',
    titles: 'Diretor de Logística,Diretor de Supply Chain,Diretor de Cadeia de Suprimentos',
    seniorities: ['c_suite'],
  },
  {
    label: 'Head / Gerente de GR (Risco)',
    nivel: 'Influenciador forte',
    titles:
      'Gerente de Risco,Head de Risco,Gerente de Gerenciamento de Risco,Gerente de Compliance',
    seniorities: ['director', 'manager'],
  },
  {
    label: 'Gerente de Operações / Transportes',
    nivel: 'Influenciador-chave',
    titles: 'Gerente de Operações,Gerente de Transportes,Gerente de Logística',
    seniorities: ['manager'],
  },
  {
    label: 'Coordenador de Monitoramento / Torre',
    nivel: 'Usuário influente',
    titles:
      'Coordenador de Monitoramento,Coordenador de Torre de Controle,Coordenador de Rastreamento,Supervisor de Frota',
    seniorities: ['manager'],
  },
  {
    label: 'Segurança Patrimonial / Corporativa',
    nivel: 'Influenciador',
    titles: 'Gerente de Segurança Patrimonial,Segurança Corporativa,Gerente de Segurança',
    seniorities: ['manager'],
  },
  {
    label: 'Jurídico / Compliance',
    nivel: 'Influenciador',
    titles: 'Jurídico,Compliance,Gerente Jurídico',
    seniorities: ['manager'],
  },
  {
    label: 'TI / Integrações / Dados',
    nivel: 'Gatekeeper',
    titles: 'TI,Tecnologia da Informação,Gerente de TI,Integrações',
    seniorities: ['manager'],
  },
  {
    label: 'Compras / Suprimentos',
    nivel: 'Gatekeeper',
    titles: 'Compras,Suprimentos,Gerente de Compras',
    seniorities: ['manager'],
  },
  {
    label: 'Financeiro / Controller',
    nivel: 'Co-decisor',
    titles: 'Financeiro,Controller,CFO,Gerente Financeiro',
    seniorities: ['director', 'manager'],
  },
] as const;
...
export const TOTALTRAC_PERSONA_OPTIONS = [
  ...
  {
    label: 'Diretor de Operações / Logística',
    nivel: 'Decisor final',
    titles: 'Diretor de Operações,COO,Diretor Operacional,Diretor de Logística',
    seniorities: ['c_suite', 'director'],
  },
  {
    label: 'Gerente de Frotas / Transportes',
    nivel: 'Influenciador-chave / Decisor',
    titles: 'Gerente de Frotas,Gerente de Transportes,Gestor de Frotas',
    seniorities: ['manager'],
  },
  {
    label: 'Gerente de Risco / Segurança',
    nivel: 'Influenciador forte',
    titles: 'Gerente de Risco,Gerente de Segurança,Segurança Patrimonial',
    seniorities: ['manager'],
  },
  {
    label: 'RH / DP (Para Jornada)',
    nivel: 'Usuário / Influenciador',
    titles: 'RH,Recursos Humanos,Departamento Pessoal,Gerente de RH',
    seniorities: ['manager'],
  },
  {
    label: 'Coordenador de Logística',
    nivel: 'Usuário influente',
    titles: 'Coordenador de Logística,Supervisor de Logística',
    seniorities: ['manager'],
  },
] as const;
...
export const PIC_OPTIONS = [
  {
    value: 'PIC1_Expansao',
    label: 'PIC 1 — Expansão Operacional',
    desc: 'Frota/rotas crescendo, mais terceiros, processo manual não acompanha.',
  },
  {
    value: 'PIC2_Risco',
    label: 'PIC 2 — Pressão de Risco',
    desc: 'Sinistro recente, exigência de seguradora, medo de não-cobertura.',
  },
  {
    value: 'PIC3_Transicao',
    label: 'PIC 3 — Transição de Liderança',
    desc: 'Novo diretor/gerente de risco, reestruturação, revisão de fornecedores.',
  },
] as const;
