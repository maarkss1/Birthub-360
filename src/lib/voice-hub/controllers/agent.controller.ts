...
export async function getAgentHandler(req: Request, res: Response) {
  const agent = await getAgent(String(req.params.id), req.organizationId!);
...
export async function createAgentHandler(req: Request, res: Response) {
  ...
  const agent = await createAgent(req.organizationId!, req.voiceHubUser?.id, parsed.data);
...
export async function deleteAgentHandler(req: Request, res: Response) {
  await deleteAgent(String(String(req.params.id)), req.organizationId!);
