      ...
      <section className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-gradient-to-r from-midnight via-[#131b38] to-[#1c1d3b] p-6 rounded-2xl text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-2xl lg:text-3xl font-black tracking-tight mt-1 text-white">
            {greeting()}, <span className="bg-gradient-to-r from-white via-gold to-sunset bg-clip-text text-transparent">{currentUser?.name?.split(' ')[0] || 'Líder'}</span>
          </h2>
        ...
        <div className="flex items-center flex-wrap gap-2.5 relative z-10">
          <button type="button" onClick={() => navigate('/app/prospect')} className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-sunset hover:bg-[#E84B35] text-white text-xs font-bold transition-all shadow-md shadow-sunset/30 hover:scale-[1.02] active:scale-[0.98] cursor-pointer">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold tracking-wider text-slate-400 uppercase">Pipeline Total</span>
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Contas estratégicas com fechamento estimado para o mês vigente.</p>
            </div>
          </div>
        </div>
              ...
              <tr className="hover:bg-slate-50/70 transition-colors">
                <td className="py-3.5 px-6">
                  <div className="font-bold text-midnight flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] bg-gold/15 text-gold font-extrabold px-1.5 py-0.2 rounded border border-gold/30">VIP</span>
                  </div>
                </td>
                ...
                <td className="py-3.5 px-4 font-black text-midnight text-sm">
                  R$ 650.000
                </td>
                <td className="py-3.5 px-4 font-semibold text-slate-700">Roberto (CIO)</td>
                <td className="py-3.5 px-6 text-right">
                  <button type="button" className="px-3 py-1.5 rounded-lg bg-midnight hover:bg-slate-800 text-white font-bold text-[11px] transition-colors shadow-xs cursor-pointer">
                    Ver Dossiê VIP
                  </button>
                </td>
              </tr>
