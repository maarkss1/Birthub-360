...
export async function scanAndGenerateAccountInsights(
  ...
  for (const organizationId of organizationIds) {
    ...
    const companies = await requestContext.run({ tenantId: organizationId }, async () => {
