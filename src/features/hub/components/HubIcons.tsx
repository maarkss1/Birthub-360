...
export const HubIcons: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
  central: (props) => (
    <svg width="52" height="52" viewBox="0 0 60 60" fill="none" {...props}>
      <rect
        x="6"
        y="8"
        width="48"
  ...
  'social-selling': (props) => (
    <svg width="46" height="46" viewBox="0 0 56 56" fill="none" {...props}>
      <defs>
      ...
      <g className="badge" transform="translate(40,12)">
        ...
        <circle cx="-3.4" cy="2.6" r="1.6" fill="var(--color-brand-ink)" />
        <circle cx="3.4" cy="2.6" r="1.6" fill="var(--color-brand-ink)" />
        <circle cx="0" cy="-3.2" r="1.6" fill="var(--color-brand-ink)" />
        <path
