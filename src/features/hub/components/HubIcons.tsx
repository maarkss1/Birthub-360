...
<<<<<<< HEAD
  "central": (props) => (<svg width="52" height="52" viewBox="0 0 60 60" fill="none" {...props}>
  ...
  "social-selling": (props) => (<svg width="46" height="46" viewBox="0 0 56 56" fill="none" {...props}>
                <defs>
  ...
  "treinamento": (props) => (<svg width="44" height="44" viewBox="0 0 50 50" fill="none" {...props}>
  ...
  "proposta": (props) => (<svg width="42" height="42" viewBox="0 0 48 48" fill="none" {...props}>
  ...
  "hub-mkt": (props) => (<svg width="42" height="42" viewBox="0 0 48 48" fill="none" {...props}>
  ...
  "sdr": (props) => (<svg width="42" height="42" viewBox="0 0 48 48" fill="none" {...props}>
  ...
  "meeting-hub": (props) => (<svg width="42" height="42" viewBox="0 0 48 48" fill="none" {...props}>
  ...
  "revenue-intel": (props) => (<svg width="42" height="42" viewBox="0 0 48 48" fill="none" {...props}>
  ...
  "connect": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>),
  "new-connect": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>),
  "securitario": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>),
  "bitrix24": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 22V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v18"/><path d="M14 9h5a1 1 0 0 1 1 1v12"/><path d="M2 22h20"/><path d="M9 6h1M9 10h1M9 14h1M9 18h1"/><path d="M17 13h1M17 17h1"/></svg>),
  "webmail": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg>),
  ...
  "workspace": (props) => (<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/></svg>),
=======
  central: (props) => (
    <svg width="52" height="52" viewBox="0 0 60 60" fill="none">
      ...
      <g transform="translate(16,25)">
        <rect width="10" height="6" rx="1.2" fill="currentColor" />
        <rect x="8" y="1.4" width="5" height="4.6" rx="1" fill="currentColor" />
        <circle cx="2.4" cy="7.2" r="1.5" fill="#FFFFFF" />
        <circle cx="9.6" cy="7.2" r="1.5" fill="#FFFFFF" />
      </g>
      <g transform="translate(36,15) scale(.85)">
        <rect width="10" height="6" rx="1.2" fill="currentColor" opacity=".85" />
        <rect x="8" y="1.4" width="5" height="4.6" rx="1" fill="currentColor" opacity=".85" />
        <circle cx="2.4" cy="7.2" r="1.5" fill="#FFFFFF" />
        <circle cx="9.6" cy="7.2" r="1.5" fill="#FFFFFF" />
      </g>
      <circle cx="49" cy="13" r="2.6" fill="#FFFFFF" />
  ...
  sdr: (props) => (
    <svg width="42" height="42" viewBox="0 0 48 48" fill="none">
      ...
      <g transform="translate(26,33)">
        <rect width="10" height="6" rx="1.2" fill="currentColor" />
        <rect x="8" y="1.4" width="5" height="4.6" rx="1" fill="currentColor" />
        <circle cx="2.4" cy="7.2" r="1.5" fill="var(--surface)" />
        <circle cx="9.6" cy="7.2" r="1.5" fill="var(--surface)" />
      </g>
    </svg>
  ),
  'meeting-hub': (props) => (
    <svg width="42" height="42" viewBox="0 0 48 48" fill="none">
      ...
      <path d="M34 18l9-5v19l-9-5z" fill="currentColor" opacity=".85" />
      <path
        d="M15 21a3.6 3.6 0 013.6 3.6c0 2.8-3.6 6.4-3.6 6.4s-3.6-3.6-3.6-6.4A3.6 3.6 0 0115 21z"
        fill="var(--brand)"
      />
    </svg>
  ),
  'revenue-intel': (props) => (
    <svg width="42" height="42" viewBox="0 0 48 48" fill="none">
      <path
        d="M6 40h36M10 40V28M18 40V22M26 40V26M34 40V16"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
