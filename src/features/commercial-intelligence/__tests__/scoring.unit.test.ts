...
function scoredDeal(
  dealOverrides: Partial<DealRow> & { id: string },
  tier: ForecastTier = 'Pipeline',
  probability = 20,
): ScoredDeal {
  return {
...
describe('scopeFilter.applyScope', () => {
  ...
  it('filtra por produto: exige que productSkus contenha o SKU informado', () => {
    const scored = [
      scoredDeal({ id: 'a', productSkus: ['SKU-1', 'SKU-2'] }),
      scoredDeal({ id: 'b', productSkus: ['SKU-3'] }),
    ];
  ...
  it('filtra por empresa: compara companyName exato', () => {
    const scored = [
      scoredDeal({ id: 'a', companyName: 'Empresa A' }),
      scoredDeal({ id: 'b', companyName: 'Empresa B' }),
    ];
    ...
    const history: StageHistoryRow[] = [
      {
        ...
        exitedAt: new Date('2026-08-05T00:00:00Z'),
      },
      {
        leadId: 'lead-2',
        stageId: 'stage-a',
  ...
  it('calcula a média quando há múltiplos segmentos concluídos na mesma etapa', () => {
    const history: StageHistoryRow[] = [
      ...
      },
      {
        ...
        stageName: 'A',
        enteredAt: new Date('2026-08-01T00:00:00Z'),
        exitedAt: new Date('2026-08-07T00:00:00Z'),
      },
    ];
  ...
  it('devolve a linha em aberto mais recente do lead naquela etapa', () => {
    const history: StageHistoryRow[] = [
      ...
      },
      {
        ...
        stageId: 'stage-a',
        stageName: 'A',
        enteredAt: new Date('2026-08-10T00:00:00Z'),
        exitedAt: null,
      },
    ];
    ...
    const history: StageHistoryRow[] = [
      {
        ...
        stageId: 'stage-a',
        stageName: 'A',
        enteredAt: new Date('2026-08-05T00:00:00Z'),
        exitedAt: null,
      },
    ];
    const count = countAdvancedTransitions(
      history,
