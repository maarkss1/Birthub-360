...
export const TOOL_BINDINGS: ToolBinding[] = [
  ...
  },
  {
    ...
    toolCode: 'agent.request-cross-role.future',
    binding:
      'Cross-Role Authorization (AccessRequest/ApprovalPolicy/TemporaryCapabilityGrant) ainda não existe — implementado no PROMPT 7.',
    available: false,
    reason: 'FUTURE_TOOL',
    verification: 'UNVERIFIED',
    evidencePath: null,
