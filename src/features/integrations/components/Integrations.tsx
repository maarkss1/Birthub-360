...
import { VoiceCallActivity } from '../birth-voice/components/VoiceCallActivity';
              ...
              <Card className="glass-card p-8 border border-gray-100 shadow-sm rounded-2xl">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Conexão usada para disparar ligações de voz por IA a partir do card do lead;
                        sem conexão cadastrada aqui, o backend cai para as variáveis de ambiente do
                        servidor.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <IntegrationTruthBox>
                    <div className="flex flex-wrap gap-2">
                      <CapabilityBadge
                        status={voiceHubConnections.length > 0 ? 'connected' : 'pending'}
                      >
                    ...
                    <p>
                      &ldquo;Testar&rdquo; confirma só que a URL responde — nunca que a API
                      key/agentId cadastrados são válidos (isso só se confirma na primeira ligação
                      real).
                    </p>
                  </IntegrationTruthBox>
