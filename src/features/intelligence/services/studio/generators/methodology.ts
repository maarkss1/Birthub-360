...
const FORMATS = {
  ...
  meddpicc:
    '{"type":"meddpicc","meta":{"persona":"string","icpSize":"string","fitAssessment":"string"},"metrics":"string","economicBuyer":"string","decisionCriteria":"string","decisionProcess":"string","paperProcess":"string","identifiedPain":"string","champion":"string","competitors":"string"}',
  challenger:
    '{"type":"challenger","meta":{"persona":"string","icpSize":"string","fitAssessment":"string"},"teach":{"title":"string","script":"string"},"tailor":{"title":"string","script":"string"},"takeControl":{"title":"string","script":"string"}}',
} as const;

export async function generateMethodology(
  request: Extract<StudioGenerationRequest, { kind: 'methodology' }>,
) {
