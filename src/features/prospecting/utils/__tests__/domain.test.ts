...
describe('prospecting domain helpers', () => {
  it('extrai o domínio de uma URL completa', () => {
    expect(normalizeCompanyDomain('https://www.rodonaves.com.br/contato')).toBe('rodonaves.com.br');
  });
  ...
  it('prioriza o website do candidato e mantém compatibilidade com o rationale', () => {
    ...
    expect(findCompanyDomain(null, 'Encontrado via Apollo — dominio: legado.com.br')).toBe(
      'legado.com.br',
    );
  });
