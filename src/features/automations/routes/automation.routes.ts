...
import { automationSchema } from '../application/AutomationUseCases';
import { runStagnationScan } from '../application/stagnation-scanner.service';
import type { AutomationController } from '../presentation/AutomationController';
