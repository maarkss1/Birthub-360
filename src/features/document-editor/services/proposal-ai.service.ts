  ...
  "closingCallToAction": "Próximos passos e validação da minuta"
    ...
    try {
      ...
      return {
        ...
        diagnosedChallenge:
          input.diagnosedPains.join(', ') ||
          'Necessidade de maior visibilidade operacional e redução de sinistros.',
        solutionScope: `Implantação dos módulos: ${input.proposedModules.join(', ')}.`,
        projectedRoiJustification:
          'Estimativa de redução substancial nos custos de sinistralidade e paradas operacionais.',
