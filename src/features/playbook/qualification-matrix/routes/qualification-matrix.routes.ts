...
import { qualificationMatrixItemSchema } from '../../playbook.schema';
import type { QualificationMatrixController } from '../presentation/QualificationMatrixController';
...
router.get('/', (req, res, next) =>
  container
    .resolve<QualificationMatrixController>('QualificationMatrixController')
    .list(req, res, next),
);
...
router.put(
  '/:id',
  writeRoles,
  validateRequest(qualificationMatrixItemSchema.partial()),
  (req, res, next) =>
    container
      .resolve<QualificationMatrixController>('QualificationMatrixController')
      .update(req, res, next),
