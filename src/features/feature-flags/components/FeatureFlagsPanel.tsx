    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {!isLoading && flags.length === 0 && (
          <p className="text-sm text-ink-2 p-4 text-center">
            Nenhum feature flag cadastrado ainda.
          </p>
        )}
            ...
            >
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {flag.isOverridden && (
                    <span className="text-[10px] font-bold uppercase tracking-wide text-brand-ink dark:text-brand bg-brand/10 px-1.5 py-0.5 rounded">
                      Personalizado
                    </span>
                  )}
                </div>
