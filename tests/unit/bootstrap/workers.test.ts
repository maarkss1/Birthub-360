...
vi.mock('../../../src/lib/queue/agent.worker.js', () => ({
  createAgentWorker: vi.fn(workerStub),
  agentQueue: {},
}));
vi.mock('../../../src/lib/queue/enrichment.queue.js', () => ({
  createEnrichmentWorker: vi.fn(workerStub),
}));
vi.mock('../../../src/lib/queue/search.queue.js', () => ({
  createSearchWorker: vi.fn(workerStub),
  searchQueue: {},
}));
vi.mock('../../../src/lib/search/index.js', () => ({
  initMeiliIndexes: vi.fn(async () => undefined),
}));
...
vi.mock('../../../src/lib/queue/whatsappSignal.worker.js', () => ({
  createWhatsAppSignalWorker: vi.fn(workerStub),
}));
