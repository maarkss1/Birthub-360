...
describe('classifyBuyingRole — nunca inventa papel sem cargo/senioridade real', () => {
  ...
  it('classifica VP/director técnico como Influenciador Técnico', () => {
    const result = classifyBuyingRole({
      role: 'Diretor de TI',
      seniority: 'director',
  ...
  it('classifica cargo técnico sem senioridade executiva como Influenciador Técnico, com confiança menor', () => {
    const withSeniority = classifyBuyingRole({
      role: 'Diretor de TI',
      seniority: 'director',
      department: null,
    });
    const withoutSeniority = classifyBuyingRole({
  ...
  it('classifica manager ou cargo operacional como Decisor Operacional', () => {
    const byManager = classifyBuyingRole({
      role: 'Coordenador',
      seniority: 'manager',
      department: null,
    });
    const byKeyword = classifyBuyingRole({
