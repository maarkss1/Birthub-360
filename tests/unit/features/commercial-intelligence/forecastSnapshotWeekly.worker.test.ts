...
vi.mock(
  '../../../../src/features/commercial-intelligence/application/CommercialIntelligenceUseCases.js',
  () => ({
...
vi.mock(
  '../../../../src/features/commercial-intelligence/infra/PrismaCommercialIntelligenceRepository.js',
  () => ({
...
vi.mock(
  '../../../../src/features/commercial-intelligence/infra/PrismaForecastSnapshotStore.js',
  () => ({
