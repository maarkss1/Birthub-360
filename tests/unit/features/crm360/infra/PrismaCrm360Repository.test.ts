...
const { ensureDefaultPipelines } =
  await import('../../../../../src/features/crm360/infra/PrismaCrm360Repository.js');
  ...
  it('pipeline já provisionado: nunca chama upsert nem releitura, mas continua rodando attachLegacyRecords', async () => {
    crmPipelineFindUnique
      ...
      .mockResolvedValueOnce(
        fullPipeline({ id: 'pipe-2', entity: CrmPipelineEntity.Negocio, sortOrder: 1 }),
      );
