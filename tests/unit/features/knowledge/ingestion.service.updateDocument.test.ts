...
vi.mock('../../../../src/lib/prisma.js', () => ({
  prisma: {
    document: {
      ...
      update: (...args: unknown[]) => documentUpdate(...args),
    },
  },
  withRlsContext: (fn: (tx: { $executeRaw: typeof executeRaw }) => unknown) =>
...
const { ingestionService } =
  await import('../../../../src/features/knowledge/ingestion.service.js');
