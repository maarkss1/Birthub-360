...
describe('ActivityService', () => {
  ...
  it('should reject a fabricated placeholder owner instead of persisting it', async () => {
    ...
    await expect(activityService.create('test-org-id', input)).rejects.toThrow(
      /não é um responsável real/,
    );
  ...
  it('should reject a fabricated placeholder owner on update too', async () => {
    ...
    await expect(
      activityService.update('test-org-id', '1', { owner: 'Vendedor 1' }),
  ...
  it('should update an activity', async () => {
    ...
    const result = await activityService.update('test-org-id', '1', {
  ...
  it('should throw error when updating non-existent activity', async () => {
    ...
    await expect(
      activityService.update('test-org-id', '1', { status: 'Concluída' as const }),
