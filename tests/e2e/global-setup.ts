...
export default async function globalSetup() {
  ...
  // Não jogamos erro — se o servidor não ficou pronto, o próprio webServer check do
  // Playwright já teria falhado antes. Aqui apenas logamos e deixamos os testes tentarem.
  console.warn(
