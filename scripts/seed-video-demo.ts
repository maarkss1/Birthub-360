...
async function main() {
  await prisma.$transaction(
    async (tx) => {
      ...
      const companySeeds = [
        {
          legalName: 'Rota Sul Transportes Ltda',
          tradeName: 'Rota Sul Transportes',
        ...
        {
          legalName: 'Nordeste Cargas Especiais S.A.',
          tradeName: 'Nordeste Cargas Especiais',
          segment: 'Logística Refrigerada',
          city: 'Recife',
          state: 'PE',
          employeeCount: 340,
        },
        {
          legalName: 'Vetor Log Distribuição Ltda',
          tradeName: 'Vetor Log Distribuição',
          segment: 'Distribuição e Armazenagem',
          city: 'Campinas',
          state: 'SP',
          employeeCount: 150,
        },
        {
          legalName: 'Malha Central Transportes S.A.',
          tradeName: 'Malha Central Transportes',
          segment: 'Transporte Rodoviário de Cargas',
          city: 'Goiânia',
          state: 'GO',
          employeeCount: 480,
        ...
        {
          legalName: 'Cerrado Frotas & Cargas Ltda',
          tradeName: 'Cerrado Frotas & Cargas',
          segment: 'Gestão de Frotas',
          city: 'Uberlândia',
          state: 'MG',
          employeeCount: 95,
        },
        {
          legalName: 'Litoral Express Logística Ltda',
          tradeName: 'Litoral Express Logística',
          segment: 'Logística Portuária',
          city: 'Santos',
          state: 'SP',
          employeeCount: 260,
        },
      ...
      const leadStages: { status: any; temperature: any; score: number; title: string }[] = [
        {
          ...
          temperature: 'Frio',
          score: 35,
          title: 'Gestão de risco de carga — diagnóstico inicial',
        },
        {
          status: 'Cadencia_Iniciada',
          temperature: 'Morno',
          score: 48,
          title: 'Monitoramento de frota — cadência ativa',
        },
        {
          status: 'Qualificacao_SDR',
          temperature: 'Morno',
          score: 60,
          title: 'Redução de sinistros — em qualificação',
        },
        {
          status: 'Reuniao_Agendada',
          temperature: 'Quente',
          score: 78,
          title: 'Piloto de rastreamento — reunião marcada',
        },
        {
          status: 'Convertido_em_Oportunidade',
          temperature: 'Quente',
          score: 85,
          title: 'Revenue OS — oportunidade aberta',
        },
        {
          status: 'Proposta_Enviada',
          temperature: 'Quente',
          score: 90,
          title: 'Contrato anual — proposta enviada',
        },
      ];
